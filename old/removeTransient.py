...
def main():
	...
	#writeTo(lFile,outputFileName)
	replace(file,'public abstract class', r'@MappedSuperClass\r\npublic class', False)
...
def replace(file,searchTerm, replaceTerm, isMulti):
	found = False	
